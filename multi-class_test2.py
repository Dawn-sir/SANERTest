...
file = open("GraphCodeResult_1/cvss2_AC_0.5(T)_new.txt", "w")

dataset=Co_training_codebert(labeled_size=0.5, test_size=0.1,stratified=True,shuffle=True,random_state=42,default_transforms=True)
