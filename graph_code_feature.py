...
class graph_code_feature:
    def __init__(self):
        self.tokenizer = RobertaTokenizer.from_pretrained('E:\PythonProject\FLSVA\graphcodebert-base')
        self.model = RobertaModel.from_pretrained('E:\PythonProject\FLSVA\graphcodebert-base')
