...
file = open("./GraphCodeResult_1/cvss2_AU_0.3(T)_new.txt", "w")

dataset=codebert(test_size=0.1,labeled_size=0.3,stratified=True,shuffle=True,random_state=0,default_transforms=True)
