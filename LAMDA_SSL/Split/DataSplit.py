...
def DataSplit(stratified=True,shuffle=True,random_state=None, X=None, y=None,size_split=None,flag=''):
    # >> Parameter
    ...
    # 将ind_1,ind_2写入文件
    # if flag == 'test':
    #     with open('test_ind_1.txt', 'w') as f:
    #         for i in ind_1:
    #             f.write(str(i) + '\n')
    #     with open('test_ind_2.txt', 'w') as f:
    #         for i in ind_2:
    #             f.write(str(i) + '\n')
    # elif flag == 'valid':
    #     with open('valid_ind_1.txt', 'w') as f:
    #         for i in ind_1:
    #             f.write(str(i) + '\n')
    #     with open('valid_ind_2.txt', 'w') as f:
    #         for i in ind_2:
    #             f.write(str(i) + '\n')
    # elif flag == 'labeled':
    #     with open('labeled_ind_1.txt', 'w') as f:
    #         for i in ind_1:
    #             f.write(str(i) + '\n')
    #     with open('labeled_ind_2.txt', 'w') as f:
    #         for i in ind_2:
    #             f.write(str(i) + '\n')
