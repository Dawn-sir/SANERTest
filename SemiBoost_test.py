...
file = open("./GraphResult/SemiBoost_cvss2_AC_0.3.txt", "w")

dataset=Co_training_codebert(test_size=0.1,labeled_size=0.3,stratified=True,shuffle=True,random_state=0,default_transforms=True)
...
model=Co_Training(gamma=10,base_estimator=SVM,evaluation=evaluation,file=file,verbose=True)
