...
dataset=Co_training_codebert(test_size=0.1,labeled_size=0.5,stratified=True,shuffle=True,random_state=0,default_transforms=True)
...
model=SSGMM(evaluation=evaluation,file=file,verbose=True, num_classes=3)
