...
print('test_X', test_X.shape, type(test_X))
# View split
...
print('split_test_X', len(split_test_X[0]), type(split_test_X))
evaluation={
    'accuracy':Accuracy(),
...
print('split_labeled_X',type(split_labeled_X), len(split_labeled_X))
print('split_unlabeled_X',type(split_unlabeled_X), len(split_unlabeled_X))
model.fit(X=split_labeled_X,y=labeled_y,unlabeled_X=split_unlabeled_X)

print('split_test_X', type(split_test_X), len(split_test_X[0]))
